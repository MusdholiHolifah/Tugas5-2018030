...
public class DataHewan extends RecyclerView.Adapter<DataHewan.HewanViewHolder> {
    String data1[], data2[], data3[];
    int images[];
    Context context;
    public DataHewan (Context ct, String s1[], String s2[],
        String s3[], int img[]){
        context = ct;
        data1 = s1;
        data2 = s2;
    ...
    @NonNull
    @Override
    public HewanViewHolder
    onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
